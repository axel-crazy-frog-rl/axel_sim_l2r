...
from baselines.rl.ddqn import run_ddqn
...
if __name__ == "__main__":
    ...
    ddqn_kwargs = params['ddqn_kwargs']
    ...
    save_path = ddqn_kwargs['save_path']
    ...
    # train an agent
    run_ddqn(sim_kwargs['racetrack'],env=env, args=ddqn_kwargs)
